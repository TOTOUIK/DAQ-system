...
* @return
*/
DLLEXPORT void matchTemplate(const GImage& sourceImage,GImage& tempImage,GPoint& minLocal, double& minValue,GCIMatchType methd=GCIMatchType::GCI_TM_SQDIFF);
...
* @param [in] sobelThreshold:sobel阈值，X和Y方向边缘梯度之和要大于该值才被认为是边缘
* @return
*/
...
* @return
*/
DLLEXPORT void convertVaildMatToGImage(gc3d::GImage& gimage,bool *maskflag,int imgW,int imgH);
